                ...
                <div class="card-body">
                    ...
                    <form id="event-form" method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="venue" type="text" class="form-control" name="venue" value="{{ old('venue') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="number_of_seats" type="number" class="form-control" name="number_of_seats" value="{{ old('number_of_seats') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ticket_price" type="number" step="0.01" class="form-control" name="ticket_price" value="{{ old('ticket_price') }}" required>
                            </div>
                        </div>
